...
uesrName.onkeyup = function() {
  let validationMessage = document.querySelector(".id-validation-message");

  if(onlyNumberAndEnglish(uesrName.value) === true) {
...
password.onkeyup = function() {
  let validationMessage = document.querySelector(".pw-validation-message");
